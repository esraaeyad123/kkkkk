      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/Admin/coupons/add_coupon') }}" name="add_coupon" id="add_coupon">{{ csrf_field() }}
              ...
              <div class="control-group">
                <label class="control-label">vaule</label>
                <div class="controls">
