      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('Admin/edit_coupon/'.$couponDetails->id) }}" name="add_coupon" id="add_coupon">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input value="{{ $couponDetails->value }}" type="number" name="amount" id="amount" required>
                </div>
              </div>
              <div class="control-group">
