            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="{{ url('/Admin/edit-servic/'.$category->id) }}" class="btn btn-primary ">Edit</a> 
	
      <a  href="{{ url('/Admin/delete-servic/'. $category->id) }}"  class="btn btn-danger deleteRecord">remove</a>   
